...
const RegistrationForm = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (props.action === "create") {
      Axios.post('http://54.204.74.125:4000/eventRoute/create-user', formData)
        .then((res) => {
          if (res.status === 200) {
      ...
      Axios.put(`http://54.204.74.125:4000/eventRoute/update-user/${props.id}`, userData)
      ...
      Axios.get("http://54.204.74.125:4000/eventRoute/event-list")
        .then((eventResponse) => {
          if (eventResponse.status === 200) {
            ...
            const eventUpdates = collectedEvents.map(event => {
              ...
              return Axios.put(`http://54.204.74.125:4000/eventRoute/update-event/${event._id}`, event);
            });
